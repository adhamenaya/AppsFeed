...
import com.adhamenaya.grability.appsfeed.util.AndroidComponentUtil;
import com.adhamenaya.grability.appsfeed.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        GrabilityApplication.get(this).getComponent().inject(this);
    }
    ...
    public int onStartCommand(Intent intent, int flags, final int startId) {
        ...
        mSubscription = mDataManager.saveApplications()
